...
<head>
    ...
    <title>Shop Homepage phone</title>
    <!-- Favicon-->
    ...
    <div class="row gx-4 gx-lg-5">
        ...
        <div class="col-lg-9 col-md-8">
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                if (!isset($_GET['brand_id'])) {
                    // Pagination links
                    $sqlCount = "SELECT COUNT(*) as count FROM products_phone WHERE product_type_ID = (SELECT product_type_ID FROM products_types WHERE type_name = 'โทรศัพท์')";
                } else {
                    // Pagination links for selected brand
                    $selectedBrandID = $_GET['brand_id'];
                    $sqlCount = "SELECT COUNT(*) as count FROM products_phone WHERE product_brand_ID = $selectedBrandID AND product_type_ID = (SELECT product_type_ID FROM products_types WHERE type_name = 'โทรศัพท์')";
                }
